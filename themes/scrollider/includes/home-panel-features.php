...
?>
			...
			<section id="sub-feature">
				...
				<div class="col-full">
					...
					<div id="social">
						<h3><?php _e('Are you a happy customer of Midnight Sun Car Rental?', 'woothemes'); ?></h3>
						<?php
					...
					<div id="features">
						...
						<?php
							...
							if ( class_exists('Woothemes_Features') ) { 
								...
								// Features Shortcode
								do_action( 'woothemes_features', array( 'title' => '', 'limit' => $settings['features_area_entries'], 'before' => '<div class="widget widget_woothemes_features home-section">', 'after' => '</div><!--/.widget widget_woothemes_features-->', 'size' => 50 ) );
